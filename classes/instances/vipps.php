...
class WC_QuickPay_Vipps extends WC_QuickPay_Instance {
	...
	public function __construct() {
		...
		add_filter( 'woocommerce_quickpay_cardtypelock_vipps', [ $this, 'filter_cardtypelock' ] );
	}
	...
	public function init_form_fields(): void {
		$this->form_fields = [
			'enabled'     => [
				...
				'type'    => 'checkbox',
				'label'   => __( 'Enable Vipps payment', 'woo-quickpay' ),
				'default' => 'no'
			],
			'_Shop_setup' => [
				'type'  => 'title',
			...
			'description' => [
				...
				'default'     => __( 'Pay with Vipps', 'woo-quickpay' )
			],
		];
	}
