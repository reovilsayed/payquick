...
class WC_QuickPay_Swish extends WC_QuickPay_Instance {
	...
	public function __construct() {
		...
		$this->method_title = 'QuickPay - Swish';
	...
	public function init_form_fields(): void {
		$this->form_fields = [
			'enabled'     => [
				...
				'type'    => 'checkbox',
				'label'   => __( 'Enable Swish payment', 'woo-quickpay' ),
				'default' => 'no'
			],
			'_Shop_setup' => [
				'type'  => 'title',
			...
			'description' => [
				...
				'default'     => __( 'Pay with Swish', 'woo-quickpay' )
			],
		];
	}
